...
trafico = poa[poa["Tipo Enquadramento"].str.contains("ENTORPECENTES - TRAFICO", na=False)]

por_bairro = trafico["Bairro"].value_counts()

print("Tráfico por bairro em Porto Alegre (2025):\n")
